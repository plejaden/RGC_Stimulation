function out = model
%
% geometry_saiful_SomaIsAxon_epiretinal_400um_s.m
%
% Model exported on Aug 21 2015, 16:10 by COMSOL 4.4.0.150.
...
model.name('geometry_saiful_SomaIsAxon_epiretinal_400um_s.mph');

model.comments('Computing the Resistance, voltage and current density of a stimulated retina.');

model.param.set('normalDistA', '0.400/2', 'distance between center and first electrode');
