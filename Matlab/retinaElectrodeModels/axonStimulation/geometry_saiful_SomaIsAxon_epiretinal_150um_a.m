function out = model
%
% geometry_saiful_SomaIsAxon_epiretinal_150um_a.m
%
% Model exported on Aug 21 2015, 16:14 by COMSOL 4.4.0.150.
...
model.name('geometry_saiful_SomaIsAxon_epiretinal_200um_a.mph');

model.comments('Computing the Resistance, voltage and current density of a stimulated retina.');

model.param.set('normalDistA', '0.200/2', 'distance between center and first electrode');
...
model.param.set('normalDistA', '0.150/2');
