function out = model
%
% geometry_saiful_SomaIsAxon_epiretinal_075um_s_development.m
%
% Model exported on Dec 26 2015, 10:48 by COMSOL 4.4.0.150.
...
model.modelPath('/home/plejaden/Dokumente/Uni/MasterThesis/trunk/src/geometrySources');

model.name('geometry_saiful_SomaIsAxon_epiretinal_500um_s_development.mph');

model.comments('Computing the Resistance, voltage and current density of a stimulated retina.');

model.param.set('normalDistA', '0.075/2', 'distance between center and first electrode');
...
model.sol('sol1').feature('s1').set('stol', '10^-3');
